...
This repository contains a Netflix clone, solely designed using HTML,CSS and JavaScript. It's an exercise in frontend development, aiming to capture the look and feel of Netflix's user interface with the use of JavaScript or any frameworks.
...
git clone https://github.com/vikasvarfa/NetFlix-Clone.git
